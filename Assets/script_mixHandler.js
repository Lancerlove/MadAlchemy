...
var checkOnce:boolean = true;	// boolean for making only a copy of the mixed object
...
function Update () {
	...
	if(resultedMix != null && checkOnce == true) {
		...
		checkOnce = false; // makes sure Update() will never enter this IF again
